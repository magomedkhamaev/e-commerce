...
import { getProducts,fetchProducts } from "../redux/slices/product";
      ...
      <Container class1="store-wrapper home-wrapper-2 py-5">
        <div className="row">
          ...
          <div className="col-9">
            ...
            <SortProduct/>
            <div className="d-flex align-items-center gap-10">
                  <p className="totalproducts mb-0">Products Grid</p>
                  <div className="d-flex gap-10 align-items-center grid">
                    <img
                      onClick={() => {
                        setGrid(3);
                      }}
                      src="https://cdn.onlinewebfonts.com/svg/img_1477.png"
