...
import { createOrder } from "../redux/slices/auth";
...
const Checkout = () => {
  ...
  const checkOutHandler = async () => {
    ...
    const options = {
      key: "rzp_test_fBXA6TmKNuWo97", // Enter the Key ID generated from the Dashboard
      amount: amount,
      currency: currency,
      name: "Khamaev Corp.",
      ...
      handler: async function (response) {
          ...
          // })
            ...
            dispatch(createOrder({totalPrice: totalAmount,totalPriceAfterDiscount:totalAmount,orderItems:cartProductState,paymentInfo: result.data,shippingInfo:JSON.parse(localStorage.getItem("address"))}))
           

         
      },
      prefill: {
          name: "magomed khamaev",
          email: "magomedkhamaev2@gmail.com",
          contact: "9999999999",
      },
      notes: {
          address: "Khamaev Corporate Office",
      },
      theme: {
          color: "#61dafb",
      },
              ...
              >
                ...
                <div className="w-100">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button   className="button"  type="submit">Prace Order</button>
                  </div>
                </div>
              </form>
            </div>
